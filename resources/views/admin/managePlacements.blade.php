            ...
            <table class=" ">
                <div class="flex justify-between px-4 items-center mt-3">
                    ...
                    <a href="{{ route('placement.create') }}"
                        class="bg-green-600 text-white px-3 py-2 rounded hover:bg-green-800">Add New Placements</a>
                </div>
                <div class="px-3 mt-4">
                        ...
                        @foreach ($placement as $item)
                            <tr>
                                ...
                                <td class="border border-slate-400 p-1 flex gap-3">
                                    <a href="{{route('placement.edit',$item)}}" class="bg-green-500 rounded px-3 py-1 text-white hover:bg-green-700">Edit</a>
